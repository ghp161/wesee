...
var format_EEZBoundariesv12MarineRegions_17 = new ol.format.GeoJSON();
var features_EEZBoundariesv12MarineRegions_17 = format_EEZBoundariesv12MarineRegions_17.readFeatures(json_EEZBoundariesv12MarineRegions_17, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EEZBoundariesv12MarineRegions_17 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EEZBoundariesv12MarineRegions_17.addFeatures(features_EEZBoundariesv12MarineRegions_17);
var lyr_EEZBoundariesv12MarineRegions_17 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EEZBoundariesv12MarineRegions_17, 
                style: style_EEZBoundariesv12MarineRegions_17,
                popuplayertitle: "EEZ Boundaries v12 Marine Regions",
                interactive: true,
                title: '<img src="styles/legend/EEZBoundariesv12MarineRegions_17.png" /> EEZ Boundaries v12 Marine Regions'
            });
...
lyr_EEZBoundariesv12MarineRegions_17.set('fieldImages', {'LINE_ID': 'TextEdit', 'LINE_NAME': 'TextEdit', 'LINE_TYPE': 'TextEdit', 'MRGID_SOV1': 'TextEdit', 'MRGID_TER1': 'TextEdit', 'TERRITORY1': 'TextEdit', 'SOVEREIGN1': 'TextEdit', 'MRGID_TER2': 'TextEdit', 'TERRITORY2': 'TextEdit', 'MRGID_SOV2': 'TextEdit', 'SOVEREIGN2': 'TextEdit', 'MRGID_EEZ1': 'TextEdit', 'EEZ1': 'TextEdit', 'MRGID_EEZ2': 'TextEdit', 'EEZ2': 'TextEdit', 'SOURCE1': 'TextEdit', 'URL1': 'TextEdit', 'SOURCE2': 'TextEdit', 'URL2': 'TextEdit', 'SOURCE3': 'TextEdit', 'URL3': 'TextEdit', 'ORIGIN': 'TextEdit', 'DOC_DATE': 'DateTime', 'MRGID_JREG': 'TextEdit', 'JOINT_REG': 'TextEdit', 'LENGTH_KM': 'TextEdit', 'MRGID_EEZ3': 'TextEdit', 'EEZ3': 'TextEdit', 'TERRITORY3': 'TextEdit', 'MRGID_TER3': 'TextEdit', 'SOVEREIGN3': 'TextEdit', 'MRGID_SOV3': 'TextEdit', });
...
lyr_EEZBoundariesv12MarineRegions_17.set('fieldLabels', {'LINE_ID': 'no label', 'LINE_NAME': 'no label', 'LINE_TYPE': 'no label', 'MRGID_SOV1': 'no label', 'MRGID_TER1': 'no label', 'TERRITORY1': 'no label', 'SOVEREIGN1': 'no label', 'MRGID_TER2': 'no label', 'TERRITORY2': 'no label', 'MRGID_SOV2': 'no label', 'SOVEREIGN2': 'no label', 'MRGID_EEZ1': 'no label', 'EEZ1': 'no label', 'MRGID_EEZ2': 'no label', 'EEZ2': 'no label', 'SOURCE1': 'no label', 'URL1': 'no label', 'SOURCE2': 'no label', 'URL2': 'no label', 'SOURCE3': 'no label', 'URL3': 'no label', 'ORIGIN': 'no label', 'DOC_DATE': 'no label', 'MRGID_JREG': 'no label', 'JOINT_REG': 'no label', 'LENGTH_KM': 'no label', 'MRGID_EEZ3': 'no label', 'EEZ3': 'no label', 'TERRITORY3': 'no label', 'MRGID_TER3': 'no label', 'SOVEREIGN3': 'no label', 'MRGID_SOV3': 'no label', });
lyr_EEZBoundariesv12MarineRegions_17.on('precompose', function(evt) {
